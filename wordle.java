...
public class wordle {
    ...
    public static void main(String[] args) {
        ArrayList<String> words =  wordlist(), display =  new ArrayList<>(Arrays.asList(
        "===============================",
        "|     |     |     |     |     |",
        "-------------------------------",
        "|     |     |     |     |     |",
    ...
    public static String sub(String guess, String ans, ArrayList check, ArrayList blackl){
        ...
        for (int num = 0; num <= 4; num++) {
            ...
            if (ans.substring(num, num+1).equals(g2)){
                disp = (num==4) ? "  |" : "  ";
                save += "|  "+ g2.toUpperCase() +disp;
            } else if (check.contains(g2)){
                disp = (num==4) ? "< |" : "< ";
                check.remove(g2);
                save += "| >"+ g2 + disp;
            } else {
